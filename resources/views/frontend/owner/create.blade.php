        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="search-wrap-1 ftco-animate">
                    <center><h1 class="mb-3 bread" style="background-color: #3FC5F0;">Post Form</h1></center>
                        ...
                        <form action="{{route('owner.store')}}" method="post" class="search-property-1 bg-light" enctype="multipart/form-data">
                            ...
                            <div class="row offset-2">
                                <div class="col-lg-6 align-items-end my-5">
                                    ...
                                    <div class="form-group">
                                        <label>Title:</label>
                                        <input type="text" name="title" class="form-control w-50 bg-dark" >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        street : <input type="text" name="st" class="form-control w-25 d-inline-block">
                            ...
                            <center>
                                <div class="form-group">
                                    <input type="submit" name="btnsubmit" value="Post Your House" class="btn w-25" style="background-color: #3FC5F0;"></div>
                                </center> 
